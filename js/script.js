...
function start() {
  ...
  inputLogin = document.getElementById('entradaemail');
  inputSenha = document.getElementById('entradasenha');
...
function showResults(results) {
  ...
  const texto = document.querySelector('.entradatexto');
  layout.classList.add('resultado');
  result.classList.add('resultado');
  document.querySelector('.entradatexto h1') &&
    document.querySelector('.entradatexto h1').remove();
    entradatexto && entradatexto.remove();
